...
const config: Config = {
  ...
  darkMode: "class",
  // Combine content globs from both configs
  content: [
  ...
  theme: {
    ...
    screens: {
      "2xsm": "375px",
      xsm: "425px",
      // You can adjust or remove custom breakpoints here
      "3xl": "2000px",
      ...defaultTheme.screens,
    },
    extend: {
      // Merge extended colors from both configs
      colors: {
      ...
      // Extend additional utilities from the second config…
      fontSize: {
        "title-xxl": ["44px", "55px"],
