      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-6 h-20 w-20 sm:h-28 sm:w-28 rounded-full bg-white/20 p-1 backdrop-blur">
              <div className="relative h-full w-full drop-shadow-2xl">
                <Image
                  src="/pfp.jpeg"
                  alt="profile"
                  fill
                  className="rounded-full object-cover  clip-path-circle"
                />
                <label
                  htmlFor="profile"
                  className="absolute bottom-0 right-0 flex h-8 w-8 sm:h-10 sm:w-10 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90"
                >
                  <svg
                    className="fill-current"
                    width="14"
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  Ambitious and dynamic frontend developer with a proven ability to deliver modern, responsive web applications that blend design and functionality. Successfully built projects such as a resume builder with shareable links, a weather app with real-time updates, and responsive Next.js portfolios, showcasing proficiency in TypeScript, CSS frameworks, and API integration. Currently expanding my skill set into backend development, aiming to become a well-rounded full-stack developer with the expertise needed to excel in the competitive tech landscape. Passionate about continuous learning, eager to embrace new technologies, and always open to exploring diverse branches of development to craft innovative solutions.
                </p>
              </div>
              ...
              <div className="mt-6.5">
                ...
                <div className="flex items-center justify-center gap-3.5">
                  <Link
                    href="/https://www.facebook.com/ibadudin.siddiqui.1/"
                  ...
                  <Link
  href="https://www.instagram.com/ibad_uddin/"
  className="group"
  aria-label="social-icon"
>
  <svg
    ...
    height="24"
    viewBox="0 0 24 24"
    className="fill-black dark:fill-white group-hover:fill-blue-500 transition-colors duration-300"
  >
